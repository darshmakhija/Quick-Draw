...
function choose(){
    ...
    todraw= quick_draw_data_set[random_no];
    document.getElementById("to_draw").innerHTML = "Sketch to Be Drawn:<br>" + todraw;
}
...
function gotResult(error, results){
    ...
    document.getElementById("you").innerHTML = "You made a/an:<br> " + answer;
    
    percentage=Math.round(results[0].confidence * 100);

    document.getElementById("confidence").innerHTML = "Confidence: " + percentage + '%';
